...
class SudokuGenerator:
    ...
    def valid_in_row(self, row, num): # uses python standard indexing (starts at 0)
    ...
    def valid_in_col(self, col, num): # uses python standard indexing (starts at 0)
    ...
    def fill_box(self, row_start, col_start):
        ...
        for i in range(self.box_length):
            for j in range(self.box_length):
                ...
                self.board[i+row_start][j+col_start] = r_num
    ...
    def remove_cells(self):
        ...
        while success < counter:
            row_rand = random.randint(0,8)
            col_rand = random.randint(0, 8)
            if self.board[row_rand][col_rand] != 0:
                self.board[row_rand][col_rand] = 0
                success += 1
